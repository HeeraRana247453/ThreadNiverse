    ...
    <main>
        <div id="carouselExampleAutoplaying" class="carousel slide m-2 m-sm-4" data-bs-ride="carousel">
            <div class="carousel-inner rounded-4 rounded-sm-5">
                ...
                <img src="https://res.cloudinary.com/dmvmebkrr/image/upload/v1727283284/jqpawxdbmvtttgbnyrub.jpg"  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="https://res.cloudinary.com/dmvmebkrr/image/upload/v1727283214/vbn4gmajehg4yhbzwtfd.jpg"  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="https://res.cloudinary.com/dmvmebkrr/image/upload/v1727283344/x4nyewbcjqqmeh3ms2vy.jpg"  class="d-block w-100" alt="...">
                </div>
            </div>
